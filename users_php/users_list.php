...
<body>
    ...
    $sql = "SELECT id_usuario, email, senha, isAdmin FROM usuarios";
    ...
    <table class="table table-hover table-striped table-bordered border-secondary">
        ...
        <tbody class="table-group-divider">
            ...
            ?>
                    <tr>
                        <td scope="row">
                            <a href="users_user.php?id_usuario=<?php echo $row['id_usuario'] ?>">
                        ...
                        <td>
                            <a href="users_edit.php?id_usuario=<?php echo $row['id_usuario'] ?>">
                                Editar
                            </a>
                        </td>
                        <td>
                            <a href="#" onclick="remove(<?php echo $row['id_usuario'] ?>)">
                                Excluir
                            </a>
                        </td>
                    </tr>
...
<script>
    function remove(id_usuario) {
        if (confirm("Tem certeza que quer deletar?")) {
            location.href = `users_del_php.php?id_usuario=${id_usuario}`
        }
    }
</script>
